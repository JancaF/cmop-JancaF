...
class Container_9ab596a290 extends Nette\DI\Container
{
	...
	public function createServiceContainer(): Container_9ab596a290
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_9ab596a290 $container,
			) {
			}
	...
	{
		return new Nette\Security\SimpleAuthenticator(
			['admin' => 'secret', 'user' => 'secret'],
