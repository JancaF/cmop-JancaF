<?php
// source: /home/filip/github-classroom/ossp-cz/cmop-JancaF-2/config/common.neon
// source: /home/filip/github-classroom/ossp-cz/cmop-JancaF-2/config/services.neon
// source: /home/filip/github-classroom/ossp-cz/cmop-JancaF-2/config/local.neon
// source: array
...
class Container_36817149a3 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presenters\PostPresenter' => [2 => ['application.1']],
		'App\Presenters\EditPresenter' => [2 => ['application.2']],
		'App\Presenters\SignPresenter' => [2 => ['application.3']],
		'App\Presenters\HomepagePresenter' => [2 => ['application.4']],
		'App\Presenters\HomePresenter' => [2 => ['application.5']],
		'App\UI\Error\Error4xx\Error4xxPresenter' => [2 => ['application.6']],
		'App\UI\Error\Error5xx\Error5xxPresenter' => [2 => ['application.7']],
		'App\Presenters\DashboardPresenter' => [2 => ['application.8']],
	...
	{
		return new App\Model\PostFacade($this->getService('database.default.explorer'), $this->getService('03'));
	}
	...
	public function createServiceApplication__1(): App\Presenters\PostPresenter
	{
		$service = new App\Presenters\PostPresenter($this->getService('02'));
	...
	public function createServiceApplication__2(): App\Presenters\EditPresenter
	{
		$service = new App\Presenters\EditPresenter($this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\Presenters\HomePresenter
	{
		$service = new App\Presenters\HomePresenter($this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__6(): App\UI\Error\Error4xx\Error4xxPresenter
	{
	...
	public function createServiceApplication__7(): App\UI\Error\Error5xx\Error5xxPresenter
	{
		return new App\UI\Error\Error5xx\Error5xxPresenter($this->getService('tracy.logger'));
	}


	public function createServiceApplication__8(): App\Presenters\DashboardPresenter
	{
		$service = new App\Presenters\DashboardPresenter($this->getService('03'), $this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__application(): Nette\Application\Application
	{
		...
		$service->error4xxPresenter = 'Error';
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/filip/github-classroom/ossp-cz/cmop-JancaF-2/temp/cache');
	}


	public function createServiceContainer(): Container_36817149a3
	{
		return $this;
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=quickstart_database',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'root'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_36817149a3 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/filip/github-classroom/ossp-cz/cmop-JancaF-2/temp/cache/latte');
	...
	{
		return new Nette\Security\User($this->getService('security.userStorage'), $this->getService('03'));
	}
